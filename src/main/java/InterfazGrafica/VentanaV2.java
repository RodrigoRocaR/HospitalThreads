...
import HospitalUtil.ThreadIniHospital;
...
public final class VentanaV2 extends javax.swing.JFrame {
    ...
    public VentanaV2() {
        ...
        iniCamposVentanaObj();
        hosp = new Hospital(cv);
        ThreadIniHospital tih = new ThreadIniHospital(hosp);
        tih.start();
    }
    ...
    /**
     * Abre el puesto de vacunación si está cerrado y lo cierra si está abierto.
     * Al no disponer del botón tenemos que obtener el boton correspondiente
     * y llamar al método que dispone de un boton como arguemento. Este último
     * método es el que realmente abre o cierra el puesto. Este método 
     * básicamente solo obtiene el botón correspondiente al puesto.
     * 
     * @param numPuesto numero del puesto a abrir o cerrar
     */
    public void abrirCerrarPuesto(int numPuesto) {
        JButton boton;
        switch (numPuesto) {
            case 0:
                boton = jButtonP1;
        ...
        abrirCerrarPuesto(numPuesto, boton);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaV2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
    ...
    public boolean[] getPuestosCerrados(){
        return hosp.getPuestosCerrados();
    }
    ...
    public void iniCamposVentanaObj() {
        ...
        // dentro del panel (mirar memoria apartado 2, parte interfaz para más detalles)
